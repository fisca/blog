<div class="container">
    <div class="row well">
        ...
        <h2 style="text-align: center;">Edit Employment data <span class="glyphicon glyphicon-briefcase"></span></h2>
        <p>&nbsp;</p>

        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/employment/edit_process">
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        ...
                        <a href="<?php echo base_url() . "index.php/employment"; ?>">Cancel</a>
                    </div>
                </div>
            </fieldset>
        </form>
