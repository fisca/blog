    ...
    <body>
        <div class="container">
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/admin/home">Home</a>
                    </div>

                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li><a href="<?php echo base_url(); ?>index.php/admin/home/do_logout">Logout</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
            ...
            <div class="row well">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <h1 style="text-align: center;">Admin Zone</h1>
                    <h3 style="text-align: center;">ThEP Researcher Database</h3>
                </div>
