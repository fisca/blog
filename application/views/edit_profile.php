<div class="container">
    <div class="row">
        ...
        <div class="col-md-12" style="background-color: #e7e3b1;">
            ...
            <h4>แก้ไข ข้อมูลประวัติส่วนตัว</h4>
            <?php
            if (!$query) :
            ...
            <form role="form" method="post" action="<?php echo base_url(); ?>index.php/profile/edit">
                <table class="table">
                    ...
                    <tr><td><strong>คำนำหน้าชื่อ</strong></td><td><input type="text" name="title_th" value="<?php echo $row->title_th; ?>"></td></tr>
                    ...
                    <tr><td><strong>นามสกุล</strong><span style="color: red;">**</span></td><td><input type="text" name="lastname_th" required value="<?php echo $row->lastname_th; ?>"></td></tr>
                        ...
                        <tr><td><strong>เพศ</strong></td>
                            <td>
                                <input type="radio" name="gender" value="male"<?php if($row->gender == 'male'){ echo ' checked'; } ?>> ชาย &nbsp;
                                <input type="radio" name="gender" value="female"<?php if($row->gender == 'female'){ echo ' checked'; } ?>> หญิง
                            </td>
                        </tr>
                        ...
                        <tr><td><strong>Email</strong><span style="color: red;">**</span></td><td><input type="email" name="email" required value="<?php echo $row->email; ?>"></td></tr>
                        <tr><td><strong>Website</strong></td><td><input type="text" name="website" value="<?php echo $row->website; ?>"></td></tr>
